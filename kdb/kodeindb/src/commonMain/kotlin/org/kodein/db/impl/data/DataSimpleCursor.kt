...
import org.kodein.memory.asManagedAllocation

class DataSimpleCursor internal constructor(it: LevelDB.Cursor, prefix: Allocation) : AbstractDataCursor(it, prefix) {
