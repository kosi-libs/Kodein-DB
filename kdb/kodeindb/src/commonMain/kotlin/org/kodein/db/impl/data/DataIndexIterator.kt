...
class DataIndexIterator internal constructor(private val ddb: DataDBImpl, it: LevelDB.Cursor, prefix: Bytes, options: LevelDB.ReadOptions) : AbstractDataIterator(it, prefix) {
