...
abstract class DBTests_00_Find : DBTests() {
    ...
    class LDB : DBTests_00_Find() { override val factory = DB.inDir(FileSystem.tempDirectory.path) }
    class IM : DBTests_00_Find() { override val factory = DB.inMemory }

    abstract class NoCache : DBTests_00_Find() {
