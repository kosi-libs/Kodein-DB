...
open class ModelDBTests_05_Polymorphism : ModelDBTests() {
    ...
    fun test01_Polymorphism() {
        ...
        val salomon = Child("Salomon", "BRYS", Date(15, 12, 1986), mdb.newHeapKey(gilbert) to mdb.newHeapKey(veronique))
        val maroussia = Child("Maroussia", "BRYS", Date(18, 8, 1988), mdb.newHeapKey(gilbert) to mdb.newHeapKey(veronique))
        val benjamin = Child("Benjamin", "BRYS", Date(23, 6, 1992), mdb.newHeapKey(gilbert) to mdb.newHeapKey(veronique))
