...
actual interface PlatformLevelDB {
    ...
    fun get(key: ByteBuffer, options: LevelDB.ReadOptions = LevelDB.ReadOptions.DEFAULT): LevelDB.NativeBytes?
    fun indirectGet(key: ByteBuffer, options: LevelDB.ReadOptions = LevelDB.ReadOptions.DEFAULT): LevelDB.NativeBytes?
