...
val configure = tasks.create<Exec>("configure") {
    ...
    args(
            ...
            "-DCMAKE_C_FLAGS:STRING=-D_GLIBCXX_USE_CXX11_ABI=0 -Wa,--mrelax-relocations=no -I${project(":ldb:lib:snappy").buildDir}/out/include -I${project(":ldb:lib:crc32c").buildDir}/out/include -pthread",
            "-DCMAKE_CXX_FLAGS:STRING=-D_GLIBCXX_USE_CXX11_ABI=0 -Wa,--mrelax-relocations=no -I${project(":ldb:lib:snappy").buildDir}/out/include -I${project(":ldb:lib:crc32c").buildDir}/out/include -pthread",
