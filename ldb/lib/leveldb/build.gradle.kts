...
val configure = tasks.create<Exec>("configure") {
    ...
    args(
            ...
            "-DCMAKE_C_FLAGS:STRING=-D_GLIBCXX_USE_CXX11_ABI=0 -pthread -Wa,--mrelax-relocations=no -I${project(":ldb:lib:snappy").buildDir}/out/include -I${project(":ldb:lib:crc32c").buildDir}/out/include --gcc-toolchain=${System.getenv("HOME")}/.konan/dependencies/target-gcc-toolchain-3-linux-x86-64",
            "-DCMAKE_CXX_FLAGS:STRING=-D_GLIBCXX_USE_CXX11_ABI=0 -pthread -Wa,--mrelax-relocations=no -I${project(":ldb:lib:snappy").buildDir}/out/include -I${project(":ldb:lib:crc32c").buildDir}/out/include --gcc-toolchain=${System.getenv("HOME")}/.konan/dependencies/target-gcc-toolchain-3-linux-x86-64",
