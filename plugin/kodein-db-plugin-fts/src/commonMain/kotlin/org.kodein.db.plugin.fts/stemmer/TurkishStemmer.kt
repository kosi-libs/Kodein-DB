...
internal class TurkishStemmer : SnowballProgram() {
    private var B_continue_stemming_noun_suffixes = false
    private var I_strlen = 0
    ...
    private fun r_mark_possessives(): Boolean {
        ...
        return if (!r_mark_suffix_with_optional_U_vowel()) {
            false
        } else true
    }
    ...
    private fun r_mark_sU(): Boolean {
        ...
        return if (!r_mark_suffix_with_optional_s_consonant()) {
            false
        } else true
    }
    ...
    private fun r_mark_lArI(): Boolean {
        // (, line 178
        // among, line 179
        return if (find_among_b(a_1, 2) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_yU(): Boolean {
        ...
        return if (!r_mark_suffix_with_optional_y_consonant()) {
            false
        } else true
    }
    ...
    private fun r_mark_nU(): Boolean {
        ...
        // among, line 190
        return if (find_among_b(a_2, 4) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_nUn(): Boolean {
        ...
        return if (!r_mark_suffix_with_optional_n_consonant()) {
            false
        } else true
    }
    ...
    private fun r_mark_nA(): Boolean {
        ...
        // among, line 207
        return if (find_among_b(a_5, 2) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_DA(): Boolean {
        ...
        // among, line 212
        return if (find_among_b(a_6, 4) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_ndA(): Boolean {
        ...
        // among, line 217
        return if (find_among_b(a_7, 2) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_DAn(): Boolean {
        ...
        // among, line 222
        return if (find_among_b(a_8, 4) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_ndAn(): Boolean {
        ...
        // among, line 227
        return if (find_among_b(a_9, 2) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_sUn(): Boolean {
        ...
        // among, line 254
        return if (find_among_b(a_13, 4) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_sUnUz(): Boolean {
        // (, line 263
        // among, line 264
        return if (find_among_b(a_15, 4) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_lAr(): Boolean {
        ...
        // among, line 269
        return if (find_among_b(a_16, 2) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_nUz(): Boolean {
        ...
        // among, line 274
        return if (find_among_b(a_17, 4) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_DUr(): Boolean {
        ...
        // among, line 279
        return if (find_among_b(a_18, 8) == 0) {
            false
        } else true
    }
    ...
    private fun r_mark_cAsInA(): Boolean {
        // (, line 282
        // among, line 283
        return if (find_among_b(a_19, 2) == 0) {
            false
        } else true
    }
    ...
    override fun hashCode(): Int {
        return TurkishStemmer::class.qualifiedName.hashCode()
    }
    ...
    companion object {
        ...
        private val a_12: Array<Among> = arrayOf<Among>(
            Among("im", -1, -1),
            Among("um", -1, -1),
            Among("\u00FCm", -1, -1),
            Among("\u0131m", -1, -1)
        )
        private val a_13: Array<Among> = arrayOf<Among>(
            Among("sin", -1, -1),
            Among("sun", -1, -1),
            Among("s\u00FCn", -1, -1),
            Among("s\u0131n", -1, -1)
        )
        private val a_14: Array<Among> = arrayOf<Among>(
            Among("iz", -1, -1),
            Among("uz", -1, -1),
            Among("\u00FCz", -1, -1),
            Among("\u0131z", -1, -1)
        )
        private val a_15: Array<Among> = arrayOf<Among>(
            Among("siniz", -1, -1),
            Among("sunuz", -1, -1),
            Among("s\u00FCn\u00FCz", -1, -1),
            Among("s\u0131n\u0131z", -1, -1)
        )
        private val a_16: Array<Among> = arrayOf<Among>(
            Among("lar", -1, -1),
            Among("ler", -1, -1)
        )
        private val a_17: Array<Among> = arrayOf<Among>(
            Among("niz", -1, -1),
            Among("nuz", -1, -1),
            Among("n\u00FCz", -1, -1),
            Among("n\u0131z", -1, -1)
        )
        private val a_18: Array<Among> = arrayOf<Among>(
            Among("dir", -1, -1),
            Among("tir", -1, -1),
            Among("dur", -1, -1),
            Among("tur", -1, -1),
        ...
        private val a_19: Array<Among> = arrayOf<Among>(
            Among("cas\u0131na", -1, -1),
            Among("cesine", -1, -1)
        )
        private val a_20: Array<Among> = arrayOf<Among>(
            Among("di", -1, -1),
            Among("ti", -1, -1),
            Among("dik", -1, -1),
            Among("tik", -1, -1),
        ...
        private val a_21: Array<Among> = arrayOf<Among>(
            Among("sa", -1, -1),
            Among("se", -1, -1),
            Among("sak", -1, -1),
            Among("sek", -1, -1),
        ...
        private val a_22: Array<Among> = arrayOf<Among>(
            Among("mi\u015F", -1, -1),
            Among("mu\u015F", -1, -1),
            Among("m\u00FC\u015F", -1, -1),
            Among("m\u0131\u015F", -1, -1)
        )
        private val a_23: Array<Among> = arrayOf<Among>(
            Among("b", -1, 1),
            Among("c", -1, 2),
            Among("d", -1, 3),
            Among("\u011F", -1, 4)
        )
        private val g_vowel = charArrayOf(
            17.toChar(),
            65.toChar(),
            16.toChar(),
            0.toChar(),
        ...
        private val g_vowel1 = charArrayOf(
            1.toChar(),
            64.toChar(),
            16.toChar(),
            0.toChar(),
        ...
        private val g_vowel2 = charArrayOf(
            17.toChar(),
            0.toChar(),
            0.toChar(),
            0.toChar(),
        ...
        private val g_vowel3 = charArrayOf(
            1.toChar(),
            0.toChar(),
            0.toChar(),
            0.toChar(),
