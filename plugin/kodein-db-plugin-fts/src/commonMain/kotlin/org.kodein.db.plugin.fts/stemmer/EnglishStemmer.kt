...
internal class EnglishStemmer : SnowballProgram() {
    private var B_Y_found = false
    private var I_p2 = 0
    private var I_p1 = 0
    ...
    private fun r_exception2(): Boolean {
        // (, line 156
        // [, line 158
        ket = cursor
        // substring, line 158
        ...
        bra = cursor
        // atlimit, line 158
        return if (cursor > limit_backward) {
            false
        } else true
    }

    private fun r_exception1(): Boolean {
        val among_var: Int
        // (, line 168
        // [, line 170
        bra = cursor
    ...
    override fun equals(other: Any?): Boolean {
        return other is EnglishStemmer
    }

    override fun hashCode(): Int {
        return EnglishStemmer::class.qualifiedName.hashCode()
    }
    ...
    companion object {
        ...
        private val g_v = charArrayOf(17.toChar(), 65.toChar(), 16.toChar(), 1.toChar())
        private val g_v_WXY = charArrayOf(1.toChar(), 17.toChar(), 65.toChar(), 208.toChar(), 1.toChar())
        private val g_valid_LI = charArrayOf(55.toChar(), 141.toChar(), 2.toChar())
    }
}